...
<div id="body-wrapper">
	<div id="content">
<fieldset>
<legend><h3>Visite Active</h3></legend> 
	<div id="active-visits_wrapper" class="dataTables_wrapper" role="grid">
		<div id="active-visits_filter" class="dataTables_filter">
			<label class="searchLabel">
				Recherche 
			<input class="inputText" type="text" id="ActiveVisite" onInput="ajaxing('ActiveVisite')">
			</label>
		</div>
	<table id="reponse1" style="width: 100%;" aria-describedby="active-visits_info" class="dataTable" id="active-visits" border="1" cellpadding="2" cellspacing="0" width="100%">
	</table>
	</div>
</fieldset>
</div>
