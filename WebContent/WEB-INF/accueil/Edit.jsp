...
<h2 class="head3">Modifier Patient</h2>
<hr>
<table style="width: 70%; margin-left: 15%; margin-right: 15%;"  class="dataTable" id="form" border="1" cellpadding="2" cellspacing="0">
	...
	<tr>
		...
		<td>
			<html:text property="patient.prenom" value="${patient.prenom }" styleClass="inputText"/>
		</td>
	</tr>
	<tr>
		<td><h4>IPP</h4></td>
	...
	<tr>
		<td></td>
		<td><html:text property="patient.ipp" disabled="disabled" value="${patient.ipp }" styleClass="inputText"/></td>
	</tr>
	<tr>
	<tr>
	...
	<tr>
		...
		<td>
			<html:text property="patient.age" value="${patient.age }" disabled="disabled" styleClass="inputText" style="width: 80px; cursor:not-allowed;"/>
		</td>
	</tr>
	<tr>
	    <td><h4>Adresse</h4></td>
	...
	<tr>
		<td></td>
		<td><html:text property="patient.pays" value="${patient.pays }" styleClass="inputText"/></td>
		<td><html:text property="patient.ville" value="${patient.ville }" styleClass="inputText"/></td>
		<td><html:text property="patient.code_postale" value="${patient.code_postale }" styleClass="inputText"/></td>
	</tr>
	<tr>
		<td></td>
	...
	<tr>
		<td></td>
		<td colspan="2">
		<html:textarea property="patient.adresse" value="${patient.adresse }" styleClass="inputText" style="width: 527px;
		height: 79px;"/>
		</td>
		<td style="vertical-align: top;">
			<html:text property="patient.num_telephone" value="${patient.num_telephone }" styleClass="inputText"/>
		</td>
    </tr>
    <tr>
	    <td>
